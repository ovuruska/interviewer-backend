...
var mongod;
var rootMongooseTestModule = function (options) {
    ...
    return mongoose_1.MongooseModule.forRootAsync({
        useFactory: function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mongodb_memory_server_1.MongoMemoryReplSet.create({ replSet: { count: 3 } })];
                    case 1:
                        mongod = _a.sent();
                        mongoUri = mongod.getUri();
                        return [2 /*return*/, __assign({ uri: mongoUri }, options)];
                }
            });
        }); }
    });
...
var closeInMongodConnection = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mongoose_2["default"].disconnect()];
            case 1:
                _a.sent();
