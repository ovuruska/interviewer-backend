...
var testing_module_1 = require("@common/Database/testing.module");
var MongoModule = /** @class */ (function () {
        ...
        (0, decorators_1.Module)({
            imports: [
                process.env.NODE_ENV === 'test'
                    ? (0, testing_module_1.rootMongooseTestModule)()
                        ...
                        useFactory: function (configService) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        _a = {};
                                        return [4 /*yield*/, configService.get('MONGODB_URL')];
                                    case 1: return [2 /*return*/, (_a.uri = _b.sent(),
                                            _a)];
                                }
                            });
                        }); },
